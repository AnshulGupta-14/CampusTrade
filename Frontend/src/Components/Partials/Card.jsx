    ...
    <>
      {isDesktop && (
        ...
        >
          ...
          <div className="w-full h-[35%] bg-zinc-300 flex flex-col justify-center items-start px-5 py-1 overflow-hidden">
            <h1 className="text-xl font-bold leading-tight">&#8377;{data.price}</h1>
            <p className="line-clamp-2 text-gray-600 leading-none">{data.title}</p>
          </div>
          <div
